...
import '../Styles/DigitalMarketingManager.css'

function DigitalMarketingManager() {
    return (
        <div>
            <div className='headbg terms'>
                <div className='head1'>Digital Marketing Manager</div>
            ...
            <div className='dmm'>
                ...
                <div className='carrerh1'>Digital Marketing Manager</div>
